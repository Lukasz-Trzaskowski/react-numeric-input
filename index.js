			...
			_createClass(NumericInput, [
				{
					...
					value: function componentWillReceiveProps(props) {
						var _value = String(props.value || props.value === 0
							? props.value
							: '').replace(/^\s*|\s*$/, "");
						this.setState({
							value: "value" in props && _value !== ''
								? this._parse(_value)
								: null
						});
					}
					...
					value: function componentDidMount() {
						...
						this.refs.input.setValue = function(value) {
							_this2.setState({value: _this2._parse(value)});
						};
						this.checkValidity();
					}
				}, {
					...
					value: function checkValidity() {
						...
						validationError = validationError || (valid
							? ""
							: this.refs.input.validationMessage || "Unknown Error");
					...
					value: function _onKeyDown(e) {
						...
						if (!e.isDefaultPrevented()) {
							if (e.keyCode === KEYCODE_UP) {
								e.preventDefault();
								this._step(e.ctrlKey || e.metaKey
									? 0.1
									: e.shiftKey
										? 10
										: 1);
					...
					value: function _invokeEventCallback(callbackName) {
						if (typeof this.props[callbackName] == "function") {
							...
							for (var _len2 = arguments.length, args = Array(_len2 > 1
								? _len2 - 1
					...
					value: function render() {
						...
						var rest = _objectWithoutProperties(_props, [
							"step",
							"min",
							"max",
							"precision",
						...
						for (var x in NumericInput.style) {
							css[x] = Object.assign({}, NumericInput.style[x], style
								? style[x] || {}
								: {});
						}
						var hasFormControl = props.className && /\bform-control\b/.test(props.className);
						var mobile = props.mobile == 'auto'
						...
						var attrs = {
							...
							input: _extends({
								...
								style: style === false
									? null
									: Object.assign({}, css.input, !hasFormControl
							...
							btnUp: {
								style: style === false
									? null
									: Object.assign({}, css.btn, css.btnUp, props.disabled
										? css['btn:disabled']
										: state.btnUpActive
											? css['btn:active']
											: state.btnUpHover
							...
							btnDown: {
								style: style === false
									? null
									: Object.assign({}, css.btn, css.btnDown, props.disabled
										? css['btn:disabled']
										: state.btnDownActive
											? css['btn:active']
											: state.btnDownHover
						...
						if (!props.disabled) {
							...
							Object.assign(attrs.btnUp, {
								...
								onMouseEnter: function onMouseEnter() {
									_this6.setState({btnUpHover: true});
								},
								onMouseLeave: function onMouseLeave() {
									_this6.stop();
									_this6.setState({btnUpHover: false, btnUpActive: false});
								},
								onMouseUp: function onMouseUp() {
									_this6.setState({btnUpHover: true, btnUpActive: false});
								},
							...
							Object.assign(attrs.btnDown, {
								...
								onTouchEnd: this.stop,
								onMouseEnter: function onMouseEnter() {
									_this6.setState({btnDownHover: true});
								},
								onMouseLeave: function onMouseLeave() {
									_this6.stop();
									_this6.setState({btnDownHover: false, btnDownActive: false});
								},
								onMouseUp: function onMouseUp() {
									_this6.setState({btnDownHover: true, btnDownActive: false});
								},
								onMouseDown: function onMouseDown() {
						...
						if (mobile) {
							return _react2.default.createElement("span", attrs.wrap, _react2.default.createElement("input", attrs.input), _react2.default.createElement("b", attrs.btnUp, _react2.default.createElement("i", {
								style: style === false
									? null
									: css.minus
